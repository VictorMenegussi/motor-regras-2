 ...
 */
export declare function contains<EntityT extends EntityV4>(substr: string | Field<EntityT> | StringFilterFunction<EntityT>, str: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function matchesPattern<EntityT extends EntityV4>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, regex: string): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function fractionalSeconds<EntityT extends EntityV4>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function totalOffsetMinutes<EntityT extends EntityV4>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 * Build a filter function to get the latest possible point in time. Evaluates to DateTimeOffset.
 * @returns The newly created filter function
 */
export declare function maxDateTime<EntityT extends EntityV4>(): NumberFilterFunction<EntityT>;
/**
 * Build a filter function to get the earliest possible point in time. Evaluates to DateTimeOffset.
 * @returns The newly created filter function
 */
export declare function minDateTime<EntityT extends EntityV4>(): NumberFilterFunction<EntityT>;
/**
 * Build a filter function to get the current point in time. Evaluates to DateTimeOffset.
 * @returns The newly created filter function
 */
export declare function now<EntityT extends EntityV4>(): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function hasSubsequence<EntityT extends EntityV4, ParamT extends FilterFunctionPrimitiveParameterType, ReturnT extends FieldType>(subsequence: ParamT[] | Field<EntityT> | CollectionFilterFunction<EntityT, ReturnT>, sequence: ParamT[] | Field<EntityT> | CollectionFilterFunction<EntityT, ReturnT>): BooleanFilterFunction<EntityT>;
/**
 ...
 */
export declare const filterFunctionsV4: {
