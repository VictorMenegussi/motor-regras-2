...
exports.filterFunctionsV4 = exports.hasSubsequence = exports.hasSubset = exports.now = exports.minDateTime = exports.maxDateTime = exports.totalOffsetMinutes = exports.fractionalSeconds = exports.matchesPattern = exports.contains = void 0;
...
function contains(substr, str) {
    return filter_function_1.filterFunctionV4('contains', 'boolean', substr, str);
}
...
function matchesPattern(str, regex) {
    return filter_function_1.filterFunctionV4('matchesPattern', 'boolean', str, regex);
}
...
function fractionalSeconds(date) {
    return filter_function_1.filterFunctionV4('fractionalseconds', 'decimal', date);
}
...
function totalOffsetMinutes(date) {
    return filter_function_1.filterFunctionV4('totaloffsetminutes', 'decimal', date);
}
...
function maxDateTime() {
    return filter_function_1.filterFunctionV4('maxdatetime', 'decimal');
}
...
function minDateTime() {
    return filter_function_1.filterFunctionV4('mindatetime', 'decimal');
}
 ...
 */
function now() {
    return filter_function_1.filterFunctionV4('now', 'decimal');
}
exports.now = now;
...
function hasSubset(subset, set) {
    return filter_function_1.filterFunctionV4('hassubset', 'boolean', subset, set);
}
...
function hasSubsequence(subsequence, sequence) {
    return filter_function_1.filterFunctionV4('hassubsequence', 'boolean', subsequence, sequence);
}
 ...
 */
exports.filterFunctionsV4 = __assign(__assign({}, filter_functions_1.filterFunctions), { contains: contains,
