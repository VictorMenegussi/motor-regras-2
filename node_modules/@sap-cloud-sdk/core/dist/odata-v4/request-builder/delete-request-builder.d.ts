import { Constructable, DeleteRequestBuilderBase, EntityIdentifiable, FieldType } from '../../odata-common';
 ...
 */
export declare class DeleteRequestBuilderV4<EntityT extends EntityV4> extends DeleteRequestBuilderBase<EntityT> implements EntityIdentifiable<EntityT> {
     ...
     */
    constructor(entityConstructor: Constructable<EntityT>, keysOrEntity: Record<string, FieldType> | EntityV4);
    /**
