...
import { CreateRequestBuilderV4, DeleteRequestBuilderV4, GetAllRequestBuilderV4, GetByKeyRequestBuilderV4, UpdateRequestBuilderV4 } from './request-builder';
/**
 ...
 */
export declare function toBatchRetrieveBodyV4(request: GetAllRequestBuilderV4<EntityV4> | GetByKeyRequestBuilderV4<EntityV4>): string;
/**
 ...
 */
export declare function toBatchChangeSetV4<T extends CreateRequestBuilderV4<EntityV4> | UpdateRequestBuilderV4<EntityV4> | DeleteRequestBuilderV4<EntityV4>>(changeSet: BatchChangeSet<T>): string | undefined;
