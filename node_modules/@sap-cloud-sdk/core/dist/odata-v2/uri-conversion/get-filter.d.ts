 ...
 */
export declare function getQueryParametersForFilter<EntityT extends EntityV2>(filter: Filterable<EntityT>, entityConstructor: Constructable<EntityT>): Partial<{
    filter: string;
}>;
