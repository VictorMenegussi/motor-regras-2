 ...
 */
export declare function substringOf<EntityT extends EntityV2>(substr: string | Field<EntityT> | StringFilterFunction<EntityT>, str: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function replace<EntityT extends EntityV2>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, searchStr: string | Field<EntityT> | StringFilterFunction<EntityT>, replaceStr: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 *  @hidden
 ...
 */
export declare const filterFunctionsV2: {
