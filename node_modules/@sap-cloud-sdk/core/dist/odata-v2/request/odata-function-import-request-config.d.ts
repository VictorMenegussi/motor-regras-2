import { ODataUri, FunctionImportParameters, RequestMethodType, ODataFunctionImportRequestConfig } from '../../odata-common';
export declare class ODataFunctionImportRequestConfigV2<ParametersT> extends ODataFunctionImportRequestConfig<ParametersT> {
    /**
