...
exports.ODataFunctionImportRequestConfigV2 = void 0;
var odata_common_1 = require("../../odata-common");
var ODataFunctionImportRequestConfigV2 = /** @class */ (function (_super) {
    __extends(ODataFunctionImportRequestConfigV2, _super);
    /**
     ...
     */
    function ODataFunctionImportRequestConfigV2(method, defaultServicePath, functionImportName, parameters, oDataUri) {
        return _super.call(this, method, defaultServicePath, functionImportName, parameters, oDataUri) || this;
    }
    ODataFunctionImportRequestConfigV2.prototype.resourcePath = function () {
        return this.functionImportName;
    };
    ODataFunctionImportRequestConfigV2.prototype.queryParameters = function () {
        var _this = this;
        return __assign(__assign({}, this.prependDollarToQueryParameters({
            ...
            queryParams[parameter.originalName] = _this.oDataUri.convertToUriFormat(parameter.value, parameter.edmType);
            return queryParams;
        }, {}));
    };
    return ODataFunctionImportRequestConfigV2;
}(odata_common_1.ODataFunctionImportRequestConfig));
exports.ODataFunctionImportRequestConfigV2 = ODataFunctionImportRequestConfigV2;
