import { EntityBase, Constructable, ODataGetByKeyRequestConfig as Base } from '../../odata-common';
/**
 ...
 */
declare class ODataGetByKeyRequestConfig<EntityT extends EntityBase> extends Base<EntityT> {
    /**
