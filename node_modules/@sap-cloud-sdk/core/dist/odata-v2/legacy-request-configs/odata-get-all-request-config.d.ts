import { ODataGetAllRequestConfig as Base, EntityBase, Constructable } from '../../odata-common';
/**
 ...
 */
declare class ODataGetAllRequestConfig<EntityT extends EntityBase> extends Base<EntityT> {
    /**
