import { EntityBase, Constructable, ODataCreateRequestConfig as Base } from '../../odata-common';
/**
 ...
 */
declare class ODataCreateRequestConfig<EntityT extends EntityBase> extends Base<EntityT> {
    /**
