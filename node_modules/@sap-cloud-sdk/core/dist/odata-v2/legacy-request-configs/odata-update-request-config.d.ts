import { EntityBase, Constructable, ODataUpdateRequestConfig as Base } from '../../odata-common';
/**
 ...
 */
declare class ODataUpdateRequestConfig<EntityT extends EntityBase> extends Base<EntityT> {
    /**
