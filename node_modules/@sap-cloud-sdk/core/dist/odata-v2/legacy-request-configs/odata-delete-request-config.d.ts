import { EntityBase, Constructable, ODataDeleteRequestConfig as Base } from '../../odata-common';
/**
 ...
 */
declare class ODataDeleteRequestConfig<EntityT extends EntityBase> extends Base<EntityT> {
    /**
