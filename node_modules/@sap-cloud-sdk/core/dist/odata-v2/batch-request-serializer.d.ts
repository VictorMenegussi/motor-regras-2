 ...
 */
export declare function toBatchRetrieveBodyV2(request: GetAllRequestBuilderV2<EntityV2> | GetByKeyRequestBuilderV2<EntityV2>): string;
/**
 ...
 */
export declare function toBatchChangeSetV2<T extends CreateRequestBuilderV2<EntityV2> | UpdateRequestBuilderV2<EntityV2> | DeleteRequestBuilderV2<EntityV2>>(changeSet: BatchChangeSet<T>): string | undefined;
