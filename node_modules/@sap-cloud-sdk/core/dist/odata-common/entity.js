...
exports.isExpandedProperty = exports.isExistentProperty = exports.isSelectedProperty = exports.EntityBase = void 0;
...
var EntityBase = /** @class */ (function () {
    function EntityBase() {
        properties_util_1.nonEnumerable(this, '_oDataVersion');
        properties_util_1.nonEnumerable(this, '_customFields');
        this._customFields = {};
    }
    EntityBase.entityBuilder = function (entityConstructor) {
    ...
    Object.defineProperty(EntityBase.prototype, "versionIdentifier", {
        /**
     ...
     */
    EntityBase.prototype.getCustomFields = function () {
     ...
     */
    EntityBase.prototype.getCustomField = function (fieldName) {
     ...
     */
    EntityBase.prototype.setCustomField = function (fieldName, value) {
     ...
     */
    EntityBase.prototype.hasCustomField = function (fieldName) {
     ...
     */
    EntityBase.prototype.initializeCustomFields = function (customFields) {
        var _this = this;
     ...
     * @returns The entity itself, to facilitate method chaining
     */
    EntityBase.prototype.setVersionIdentifier = function (etag) {
        if (etag && typeof etag === 'string') {
            properties_util_1.nonEnumerable(this, '_versionIdentifier');
     ...
     * @returns The entity itself, to facilitate method chaining
     */
    EntityBase.prototype.setOrInitializeRemoteState = function (state) {
        var _this = this;
        if (!this.remoteState) {
            properties_util_1.nonEnumerable(this, 'remoteState');
            this.remoteState = {};
        }
        if (state) {
     ...
     */
    EntityBase.prototype.getUpdatedCustomFields = function () {
        var _this = this;
     ...
     */
    EntityBase.prototype.getUpdatedProperties = function () {
        var _this = this;
        ...
        Object.keys(current)
            ...
            if (!util_1.equal(_this.remoteState[key], current[key])) {
     ...
     */
    EntityBase.prototype.getCurrentMapKeys = function (visitedEntities) {
        var _this = this;
        ...
        return Object.keys(this)
            .filter(function (key) { return _this.propertyIsEnumerable(key); })
            .filter(function (key) {
            return !properties_util_1.isNavigationProperty(key, _this.constructor) ||
    ...
    EntityBase.prototype.isVisitedEntity = function (entity, visitedEntities) {
        if (visitedEntities === void 0) { visitedEntities = []; }
        var isVisited = Array.isArray(entity)
            ? entity.some(function (multiLinkChild) { return visitedEntities.includes(multiLinkChild); })
            : visitedEntities.includes(entity);
        return isVisited;
    };
    EntityBase.prototype.getCurrentStateForKey = function (key, visitedEntities) {
        if (visitedEntities === void 0) { visitedEntities = []; }
        if (properties_util_1.isNavigationProperty(key, this.constructor)) {
            if (util_1.isNullish(this[key])) {
                return this[key];
            }
        ...
        return Array.isArray(this[key]) ? __spreadArrays(this[key]) : this[key];
    };
    /**
     ...
     */
    EntityBase.prototype.isConflictingCustomField = function (customFieldName) {
