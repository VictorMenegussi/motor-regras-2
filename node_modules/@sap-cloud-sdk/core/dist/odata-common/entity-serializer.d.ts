import { Constructable, EntityBase, ComplexTypeNamespace, EdmTypeShared } from '../odata-common';
/**
 * Interface representing the return type of the builder function [[entitySerializer]].
 */
export interface EntitySerializer<EntityT extends EntityBase = any, ComplexTypeNamespaceT extends ComplexTypeNamespace<any> = any> {
