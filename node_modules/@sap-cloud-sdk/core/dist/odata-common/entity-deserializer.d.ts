import { EntityBase, Constructable, ComplexTypeNamespace, EdmTypeShared } from '../odata-common';
 ...
 */
export declare function extractCustomFields<EntityT extends EntityBase, JsonT>(json: Partial<JsonT>, entityConstructor: Constructable<EntityT>): Record<string, any>;
export {};
