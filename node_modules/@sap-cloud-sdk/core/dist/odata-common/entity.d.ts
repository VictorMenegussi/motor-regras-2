 ...
 * @hidden
 */
export interface Constructable<EntityT extends EntityBase, EntityTypeT = unknown> {
    _serviceName: string;
    _entityName: string;
...
export declare type EntityBuilderType<EntityT extends EntityBase, EntityTypeT> = {
...
export declare abstract class EntityBase {
    ...
    protected static entityBuilder<EntityT extends EntityBase, EntityTypeT>(entityConstructor: Constructable<EntityT, EntityTypeT>): EntityBuilderType<EntityT, EntityTypeT>;
    /**
 ...
 * @hidden
 */
export declare function isExistentProperty<EntityT extends EntityBase, LinkedEntityT extends EntityBase>(json: any, link: Link<EntityT, LinkedEntityT>): any;
/**
 * @hidden
 */
export declare function isExpandedProperty<EntityT extends EntityBase, LinkedEntityT extends EntityBase>(json: any, link: Link<EntityT, LinkedEntityT>): any;
