 ...
 */
var ActionFunctionImportRequestBuilderBase = /** @class */ (function (_super) {
    __extends(ActionFunctionImportRequestBuilderBase, _super);
    /**
     ...
     */
    function ActionFunctionImportRequestBuilderBase(responseTransformer, requestConfig) {
     ...
     */
    ActionFunctionImportRequestBuilderBase.prototype.execute = function (destination, options) {
    ...
    return ActionFunctionImportRequestBuilderBase;
