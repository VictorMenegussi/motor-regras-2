 ...
 */
var DeleteRequestBuilderBase = /** @class */ (function (_super) {
    __extends(DeleteRequestBuilderBase, _super);
    /**
     ...
     */
    function DeleteRequestBuilderBase(entityConstructor, oDataUri, keysOrEntity) {
        ...
        if (keysOrEntity instanceof entity_1.EntityBase) {
     ...
     */
    DeleteRequestBuilderBase.prototype.ignoreVersionIdentifier = function () {
     ...
     */
    DeleteRequestBuilderBase.prototype.execute = function (destination, options) {
    ...
    return DeleteRequestBuilderBase;
