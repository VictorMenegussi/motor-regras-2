 ...
 */
var UpdateRequestBuilderBase = /** @class */ (function (_super) {
    __extends(UpdateRequestBuilderBase, _super);
    /**
     ...
     */
    function UpdateRequestBuilderBase(_entityConstructor, _entity, oDataUri, entitySerializer, extractODataEtag, payloadManipulator) {
    ...
    Object.defineProperty(UpdateRequestBuilderBase.prototype, "entity", {
        get: function () {
            return this._entity;
        },
        enumerable: false,
     ...
     */
    UpdateRequestBuilderBase.prototype.prepare = function () {
     ...
     */
    UpdateRequestBuilderBase.prototype.replaceWholeEntityWithPut = function () {
        this.requestConfig.updateWithPut();
        this.requestConfig.payload = this.getPayload();
        return this;
    };
    UpdateRequestBuilderBase.prototype.requiredFields = function (first) {
        var rest = [];
    ...
    UpdateRequestBuilderBase.prototype.setRequiredFields = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
    ...
    UpdateRequestBuilderBase.prototype.ignoredFields = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
    ...
    UpdateRequestBuilderBase.prototype.setIgnoredFields = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
     ...
     */
    UpdateRequestBuilderBase.prototype.ignoreVersionIdentifier = function () {
     ...
     */
    UpdateRequestBuilderBase.prototype.withCustomVersionIdentifier = function (etag) {
     ...
     * @returns The request itself to ease chaining while executing the request
     */
    UpdateRequestBuilderBase.prototype.setVersionIdentifier = function (etag) {
        this.requestConfig.eTag = etag;
        return this;
    };
    /**
     ...
     */
    UpdateRequestBuilderBase.prototype.executeRequest = function (request) {
    ...
    UpdateRequestBuilderBase.prototype.getPayload = function () {
    ...
    UpdateRequestBuilderBase.prototype.isEmptyObject = function (obj) {
        for (var key in obj) {
    ...
    UpdateRequestBuilderBase.prototype.addRequiredFields = function (completeBody, body) {
    ...
    UpdateRequestBuilderBase.prototype.getKeyFieldNames = function () {
        return Object.keys(this._entityConstructor._keys);
    };
    UpdateRequestBuilderBase.prototype.toSet = function (fields) {
        var set = new Set();
    ...
    UpdateRequestBuilderBase.prototype.serializedDiff = function () {
        return __assign(__assign({}, this.entitySerializer.serializeEntityNonCustomFields(this._entity.getUpdatedProperties(), this._entityConstructor)), this._entity.getUpdatedCustomFields());
    };
    UpdateRequestBuilderBase.prototype.removeKeyFields = function (body) {
        var _this = this;
    ...
    UpdateRequestBuilderBase.prototype.removeIgnoredFields = function (body) {
        var _this = this;
        return removePropertyOnCondition(function (_a) {
            var key = _a[0], val = _a[1];
    ...
    return UpdateRequestBuilderBase;
