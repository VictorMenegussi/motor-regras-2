 ...
 */
export declare function serializeRequest(request: MethodRequestBuilderBase, options?: BatchRequestSerializationOptions): string;
/**
 ...
 */
export declare function getLine(request: MethodRequestBuilderBase): string;
