 ...
 */
export declare class BatchRequestBuilder extends MethodRequestBuilderBase<ODataBatchRequestConfig> {
     ...
     */
    constructor(defaultServicePath: string, requests: (BatchChangeSet | MethodRequestBuilderBase)[], entityToConstructorMap: Record<string, Constructable<EntityBase>>);
